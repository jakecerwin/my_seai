...
# train test split for imdb added data
...
# k best features random forest regression
...
print('dt')
dt_regression(train2, test2)
dt_regression(train1, test1)
print('k_best')
